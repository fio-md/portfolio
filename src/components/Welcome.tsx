export default function Welcome() {
  return (
    <section className="min-h-full h-dvh flex flex-col justify-center items-center dark:bg-gradient-to-b dark:from-zinc-800 dark:to-zinc-900">
      ...
      <div className="max-w-lg py-8 px-8 my-16 border-yellow-200 border-2">
